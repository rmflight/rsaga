...
```{r initPop}
neighborFunction <- function(currentPopulation = currSolution, currentTemperature = currTemp, alpha = alpha){
  # an alpha of 0 means temperature has no effect
  newPopulation <- runif(8, 0, 200)
  newPopulation[2] <- runif(1, 0, 1)
...
outSA <- sa(initialSolution, energyFunc, neighborFunction, initTemp, deltaTemperature=100, alpha=0.2, nTry=1e5)
```
